...
![Julius Caesar — Giovan Battista Bellaso — Blaise de Vigenère](https://r2.kayaberkay.org/cryptography/vigenere/vigenere0.webp)
...
![Caesar ciphering with E](https://r2.kayaberkay.org/cryptography/vigenere/vigenere1.webp)
...
![Caesar ciphering table with E](https://r2.kayaberkay.org/cryptography/vigenere/vigenere2.webp)

In the Vigenère cipher, since **two alphabets** are used, we require a table known as the **Tabula Recta**.

![Tabula Recta](https://r2.kayaberkay.org/cryptography/vigenere/vigenere3.webp)

Alternatively, one can use sophisticated tools such as the **Alberti Cipher Disc**.

![Alberti Cipher Disc](https://r2.kayaberkay.org/cryptography/vigenere/vigenere4.webp)
...
![Vigenère ciphering with "key"](https://r2.kayaberkay.org/cryptography/vigenere/vigenere5.webp)

For decryption, we apply the **subtraction operation**.

![Vigenère deciphering with "key"](https://r2.kayaberkay.org/cryptography/vigenere/vigenere6.webp)
...
![Vigenère ciphering with "key"](https://r2.kayaberkay.org/cryptography/vigenere/vigenere7.webp)
